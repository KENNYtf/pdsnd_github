...
def get_filters():
    ...
    while True:
        ...
        if city in cities:
            if city == 'washington':
                print('Please note that there is no gender calculation for the selected city')
            break
        else:
    ...
    while True:
        ...
        month = input("Which month would you like to consider?: ").title()
        if month in months:
            break
        else:
    ...
    while True:
        ...
        day = input("Which day of the week would you like to consider?: ").title()
        if day in days:
            break
        else:
...
def trip_duration_stats(df):
    ...
    hour,minute_=divmod(minute,60)
    print("The total trip duration: {} hour(s) {} minute_(s) {} second(s)".format(hour,minute_,second))
    ...
    if m>60:
        h,m=divmod(m,60)
        print("The total trip duration: {} hour(s) {} minute_(s) {} second(s)".format(h,m,sec))
    else:
        print("The total trip duration: {} minute_(s) {} second(s)".format(m,sec))
